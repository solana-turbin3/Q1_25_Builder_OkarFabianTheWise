...
const to = new
PublicKey("EQwTVcC9gQAPAbuXKJNAG4Rahm7BgXEcV3Rq9xa8CEvS");
...
//                 toPubkey: to,
//                 lamports: 0.09 * LAMPORTS_PER_SOL, // observed it was 0.01 as against the 0.1 in the task, so i sent 0.09 more to make up for the 0.1 SOL in the task
//             })
//         );
